...
require "kite/git/version"

Gem::Specification.new do |spec|
  spec.name          = "kite-git"
  spec.version       = Kite::Git::VERSION
  spec.authors       = ["vshatravenko"]
  spec.email         = ["vshatravenko@heliostech.fr"]

  spec.summary       = %q{Kite Git wrapper}
  spec.description   = %q{A basic plugin providing a git wrapper for Kite}
